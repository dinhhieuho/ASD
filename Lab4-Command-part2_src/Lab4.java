...
public class Lab4 extends javax.swing.JFrame
{
    ...
    //CommandPop pop = new CommandPop(stack);
    //CommandPush push = new CommandPush(stack);
	...
	void JButtonPush_actionPerformed(java.awt.event.ActionEvent event)
	{
	    ...
	    manager.setCommand(new CommandPush(stack, pushstring));
	    manager.execute();
	...
	void JButtonPop_actionPerformed(java.awt.event.ActionEvent event)
	{
		...
		manager.setCommand(new CommandPop(stack));
	    manager.execute();
